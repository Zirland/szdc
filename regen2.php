...
switch ($type) {
    case 'CZPTTCISMessage':
        ...
        echo "$query284<br/>";
        $query223 = "INSERT INTO trip (route_id, trip_id, trip_headsign, direction_id, shape_id, wheelchair_accessible, bikes_allowed, active, train_no) VALUES ('$route_id', '$trip_id', '$headsign', '$odd', '$trasa','0', '0', '1', '$newtrip', '$block');";
        echo "$query223<br/>";
